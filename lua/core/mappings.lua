...
M.lspconfig = {
    ...
    n = {
        ...
        ["<leader>ra"] = {
            function() require("nvchad.renamer").open() end, "LSP rename"
        },
...
M.gitsigns = {
    ...
    n = {
        ...
        -- Actions
        ["<leader>rh"] = {
            function() require("gitsigns").reset_hunk() end, "Reset hunk"
        },

        ["<leader>ph"] = {
            function() require("gitsigns").preview_hunk() end, "Preview hunk"
        },

        ["<leader>gb"] = {
            function() package.loaded.gitsigns.blame_line() end, "Blame line"
        },
